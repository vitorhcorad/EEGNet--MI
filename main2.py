...
dataset = cbcic(subject=1, path='C:/Users/Vitor/OneDrive/Documentos/EEGNet/temp_dataset/')
...
modelo_eeg = eegnet_mi(
    ...
    F1=16,           # Mais filtros para capturar padrões temporais
    D=8,             # tentando pegar mais eletrodos
